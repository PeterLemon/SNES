...
define BassDrumC9Pitch($8000)
define SnareC9Pitch($8000)
define HihatClosedC9Pitch($8000)
define TomtomFloorC9Pitch($8000)
define BassGuitarC9Pitch($A820)
define BassSynthC9Pitch($B2C8)
define ElectroSynthC9Pitch($8610)
define SynthC9Pitch($FB00)
