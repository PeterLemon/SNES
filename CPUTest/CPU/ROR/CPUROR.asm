// SNES 65816 CPU Test ROR (Rotate Right) demo by krom (Peter Lemon):
arch snes.cpu
output "CPUROR.sfc", create
...
seek($8000); Start:
  ...
  PrintText(RORA, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(RORAddr, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  ror.w AbsoluteData // Rotate Right Memory
  ...
  // Print Syntax/Opcode Text
  PrintText(RORDP, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  lda.b #$01 // A = $01
  sta.b AbsoluteData // Store Absolute Data
  ror.b AbsoluteData // Rotate Right Memory
  ...
  // Print Syntax/Opcode Text
  PrintText(RORAddrX, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  sta.b AbsoluteData // Store Absolute Data
  ldx.w #0 // X = 0
  ror.w AbsoluteData,x // Rotate Right Memory
  ...
  // Print Syntax/Opcode Text
  PrintText(RORDPX, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  sta.b AbsoluteData // Store Absolute Data
  ldx.w #0 // X = 0
  ror.b AbsoluteData,x // Rotate Right Memory
...
RORA:
  db "ROR A        (Opcode: $6A)"
RORAddr:
  db "ROR addr     (Opcode: $6E)"
RORDP:
  db "ROR dp       (Opcode: $66)"
RORAddrX:
  db "ROR addr,X   (Opcode: $7E)"
RORDPX:
  db "ROR dp,X     (Opcode: $76)"
