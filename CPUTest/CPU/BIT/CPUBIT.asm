// SNES 65816 CPU Test BIT (Test Memory Bits) demo by krom (Peter Lemon):
arch snes.cpu
output "CPUBIT.sfc", create
...
seek($8000); Start:
  ...
  PrintText(BITConst, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(BITAddr, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(BITDP, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(BITAddrX, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(BITDPX, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(TRBAddr, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(TRBDP, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(TSBAddr, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(TSBDP, $F902, 26) // Load Text To VRAM Lo Bytes
...
BITConst:
  db "BIT #const   (Opcode: $89)"
BITAddr:
  db "BIT addr     (Opcode: $2C)"
BITDP:
  db "BIT dp       (Opcode: $24)"
BITAddrX:
  db "BIT addr,X   (Opcode: $3C)"
BITDPX:
  db "BIT dp,X     (Opcode: $34)"
TRBAddr:
  db "TRB addr     (Opcode: $1C)"
TRBDP:
  db "TRB dp       (Opcode: $14)"
TSBAddr:
  db "TSB addr     (Opcode: $0C)"
TSBDP:
  db "TSB dp       (Opcode: $04)"

BITConstResultCheckA:
  db $00
PSRConstResultCheckA:
  db $26

BITConstResultCheckB:
  db $7F
PSRConstResultCheckB:
  db $24

BITConstResultCheckC:
  dw $0000
PSRConstResultCheckC:
  db $06

BITConstResultCheckD:
  dw $7FFF
PSRConstResultCheckD:
  db $04
