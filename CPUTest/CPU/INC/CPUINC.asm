// SNES 65816 CPU Test INC (Increment) demo by krom (Peter Lemon):
arch snes.cpu
output "CPUINC.sfc", create
...
seek($8000); Start:
  ...
  // Print Syntax/Opcode Text
  PrintText(INCAddrX, $F902, 26) // Load Text To VRAM Lo Bytes
