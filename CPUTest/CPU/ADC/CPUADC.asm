...
seek($8000); Start:
  ...
  // Print Syntax/Opcode Text
  PrintText(ADCDPIndirectLongY, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(ADCSRS, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(ADCSRSY, $F902, 26) // Load Text To VRAM Lo Bytes
