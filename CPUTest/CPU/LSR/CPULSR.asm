...
seek($8000); Start:
  ...
  PrintText(LSRA, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(LSRAddr, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(LSRDP, $F902, 26) // Load Text To VRAM Lo Bytes
