// SNES SPC700 CPU Test EOR (Exclusive-OR With Memory) demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "SPC700EOR.sfc", create
...
seek($8000); Start:
  ...
  // Print Syntax/Opcode Text
  PrintText(EORIndirectX, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(EORIndirectXY, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(EORDPConst, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(EORDPDP, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(EORAddrBit, $F902, 26) // Load Text To VRAM Lo Bytes
...
Title:
  db "SPC Test EOR (XOR With Memory):"
...
EORConst:
  db "EOR #const   (Opcode: $48)"
EORAddr:
  db "EOR addr     (Opcode: $45)"
EORDP:
  db "EOR dp       (Opcode: $44)"
EORAddrX:
  db "EOR addr,X   (Opcode: $55)"
EORAddrY:
  db "EOR addr,Y   (Opcode: $56)"
EORDPX:
  db "EOR dp,X     (Opcode: $54)"
EORDPIndirectX:
  db "EOR (dp,X)   (Opcode: $47)"
EORDPIndirectY:
  db "EOR (dp),Y   (Opcode: $57)"
EORIndirectX:
  db "EOR (X)      (Opcode: $46)"
EORIndirectXY:
  db "EOR (X)=(Y)  (Opcode: $59)"
EORDPConst:
  db "EOR dp=#const(Opcode: $58)"
EORDPDP:
  db "EOR dp=dp    (Opcode: $49)"
EORAddrBit:
  db "EOR addr:bit (Opcode: $8A)"
