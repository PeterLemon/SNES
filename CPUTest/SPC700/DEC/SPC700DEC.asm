// SNES SPC700 CPU Test DEC (Decrement) demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "SPC700DEC.sfc", create
...
DECA:
  db "DEC A        (Opcode: $9C)"
DECAddr:
  db "DEC addr     (Opcode: $8C)"
DECDP:
  db "DEC dp       (Opcode: $8B)"
DECDPX:
  db "DEC dp,X     (Opcode: $9B)"
DECX:
  db "DEX          (Opcode: $1D)"
DECY:
  db "DEY          (Opcode: $DC)"
