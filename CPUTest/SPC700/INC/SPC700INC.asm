...
seek($8000); Start:
  ...
  // Print Result Text
  PrintText(INCRESULT1, $FA02, 21) // Load Text To VRAM Lo Bytes
  ...
  // Print Result Text
  PrintText(INCRESULT2, $FA42, 21) // Load Text To VRAM Lo Bytes
  ...
  /////////////////////////////////////////////////////////////////
  // Print Result Text
  PrintText(INCRESULT3, $FA02, 21) // Load Text To VRAM Lo Bytes
  ...
  // Print Result Text
  PrintText(INCRESULT4, $FA42, 21) // Load Text To VRAM Lo Bytes
