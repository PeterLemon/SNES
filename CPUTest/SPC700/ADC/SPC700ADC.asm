// SNES SPC700 CPU Test ADC (Add With Carry) demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "SPC700ADC.sfc", create
...
seek($8000); Start:
  ...
  // Print Syntax/Opcode Text
  PrintText(ADCDPIndirectX, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(ADCDPIndirectY, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(ADCIndirectX, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(ADCIndirectXY, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(ADCDPConst, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(ADCDPDP, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(ADDW, $F902, 26) // Load Text To VRAM Lo Bytes
...
Title:
  db "SPC Test ADC (Add With Carry):"
...
ADCConst:
  db "ADC #const   (Opcode: $88)"
ADCAddr:
  db "ADC addr     (Opcode: $85)"
ADCDP:
  db "ADC dp       (Opcode: $84)"
ADCAddrX:
  db "ADC addr,X   (Opcode: $95)"
ADCAddrY:
  db "ADC addr,Y   (Opcode: $96)"
ADCDPX:
  db "ADC dp,X     (Opcode: $94)"
ADCDPIndirectX:
  db "ADC (dp,X)   (Opcode: $87)"
ADCDPIndirectY:
  db "ADC (dp),Y   (Opcode: $97)"
ADCIndirectX:
  db "ADC (X)      (Opcode: $86)"
ADCIndirectXY:
  db "ADC (X)=(Y)  (Opcode: $99)"
ADCDPConst:
  db "ADC dp=#const(Opcode: $98)"
ADCDPDP:
  db "ADC dp=dp    (Opcode: $89)"
ADDW:
  db "ADW dp       (Opcode: $7A)"
