// SNES SPC700 CPU Test ORA (OR With Memory) demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "SPC700ORA.sfc", create
...
seek($8000); Start:
  ...
  // Print Syntax/Opcode Text
  PrintText(ORAIndirectX, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(ORRIndirectXY, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(ORRDPConst, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(ORRDPDP, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(ORCAddrBit, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(ORCNOTAddrBit, $F902, 26) // Load Text To VRAM Lo Bytes
...
Title:
  db "SPC Test ORA (OR With Memory):"
...
ORAConst:
  db "ORA #const   (Opcode: $08)"
ORAAddr:
  db "ORA addr     (Opcode: $05)"
ORADP:
  db "ORA dp       (Opcode: $04)"
ORAAddrX:
  db "ORA addr,X   (Opcode: $15)"
ORAAddrY:
  db "ORA addr,Y   (Opcode: $16)"
ORADPX:
  db "ORA dp,X     (Opcode: $14)"
ORADPIndirectX:
  db "ORA (dp,X)   (Opcode: $07)"
ORADPIndirectY:
  db "ORA (dp),Y   (Opcode: $17)"
ORAIndirectX:
  db "ORA (X)      (Opcode: $06)"
ORRIndirectXY:
  db "ORR (X)=(Y)  (Opcode: $19)"
ORRDPConst:
  db "ORR dp=#const(Opcode: $18)"
ORRDPDP:
  db "ORR dp=dp    (Opcode: $09)"
ORCAddrBit:
  db "ORC addr:bit (Opcode: $0A)"
ORCNOTAddrBit:
  db "ORC !addr:bit(Opcode: $2A)"
