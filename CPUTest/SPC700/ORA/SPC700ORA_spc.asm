// SNES SPC700 CPU Test ORA (OR With Memory) demo (SPC Code) by krom (Peter Lemon):
arch snes.smp
output "SPC700ORA.spc", create
...
SongStart:
  ...
  // Run Test
  str $E1=#$0F // Store Indirect Data
  str $E2=#$F0 // Store Indirect Data
  ldx #$E1 // X = Indirect Data
  ldy #$E2 // Y = Indirect Data
  orr (x)=(y) // (X) |= (Y)
  php // Push Processor Status Register To Stack
