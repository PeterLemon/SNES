// SNES SPC700 CPU Test AND (AND With Memory) demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "SPC700AND.sfc", create
...
seek($8000); Start:
  ...
  // Print Syntax/Opcode Text
  PrintText(ANDIndirectX, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(ANDIndirectXY, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(ANDDPConst, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(ANDDPDP, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(ANDAddrBit, $F902, 26) // Load Text To VRAM Lo Bytes
  ...
  // Print Syntax/Opcode Text
  PrintText(ANDNOTAddrBit, $F902, 26) // Load Text To VRAM Lo Bytes
...
Title:
  db "SPC Test AND (AND With Memory):"
...
ANDConst:
  db "AND #const   (Opcode: $28)"
ANDAddr:
  db "AND addr     (Opcode: $25)"
ANDDP:
  db "AND dp       (Opcode: $24)"
ANDAddrX:
  db "AND addr,X   (Opcode: $35)"
ANDAddrY:
  db "AND addr,Y   (Opcode: $36)"
ANDDPX:
  db "AND dp,X     (Opcode: $34)"
ANDDPIndirectX:
  db "AND (dp,X)   (Opcode: $27)"
ANDDPIndirectY:
  db "AND (dp),Y   (Opcode: $37)"
ANDIndirectX:
  db "AND (X)      (Opcode: $26)"
ANDIndirectXY:
  db "AND (X)=(Y)  (Opcode: $39)"
ANDDPConst:
  db "AND dp=#const(Opcode: $38)"
ANDDPDP:
  db "AND dp=dp    (Opcode: $29)"
ANDAddrBit:
  db "AND addr:bit (Opcode: $4A)"
ANDNOTAddrBit:
  db "AND !addr:bit(Opcode: $6A)"
