// SNES PPU BG 8x8 8BPP 32x64 Demo by krom (Peter Lemon):
arch snes.cpu
output "8x8BGMap8BPP32x64.sfc", create
...
seek($8000); Start:
  ...
  lda.b #%00000010  // AAAAAASS: S = BG Map Size, A = BG Map Address
  sta.w REG_BG1SC   // $2107: BG1 32x64, BG1 Map Address = $0000 (VRAM Address / $400)
