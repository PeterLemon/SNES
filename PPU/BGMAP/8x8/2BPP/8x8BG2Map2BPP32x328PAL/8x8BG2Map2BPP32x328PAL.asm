// SNES PPU BG2 8x8 2BPP 32x32 8 Palette Demo by krom (Peter Lemon):
arch snes.cpu
output "8x8BG2Map2BPP32x328PAL.sfc", create
...
seek($8000); Start:
  ...
  LoadPAL(BGPal, $20, BGPal.size, 0) // Load Background Palette (BG Palette Uses 32 Colors)
  ...
  sta.w REG_BGMODE // $2105: BG Mode 0, Priority 0, BG2 8x8 Tiles
