...
seek($8000); Start:
  ...
  LoadPAL(BGPal, $00, BGPal.size, 0) // Load Background Palette (BG Palette Uses 256 Colours)
  ...
  lda.b #$01
  sta {REG_NMITIMEN} // Enable Joypad NMI Reading Interrupt
  ...
  lda.b #%11100000   // Load Green Colour Low Byte
  sta.w {REG_CGDATA} // $2122: CGRAM Data Write Lo Byte
  lda.b #%00000011   // Load Green Colour High Byte
