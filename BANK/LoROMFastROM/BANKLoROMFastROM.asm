// SNES Bank LoROM/FastROM demo by krom (Peter Lemon):
// 1. Jump To Bank Code
...
arch snes.cpu
output "BANKLoROMFastROM.sfc", create

macro seek(variable offset) {
  origin ((offset & $7F0000) >> 1) | (offset & $7FFF)
  base offset | $800000 // LoROM/FastROM
}
...
Title:
  db "Bank Test LoROM/FastROM ($80):"

PageBreak:
  db "------------------------------"

BANKTEXT:
  db "Jump To Bank 1 ($81)    PASSED"
