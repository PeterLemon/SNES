// SNES MSU1 Touhou - Bad Apple! 30 Frames Per Second 4 Color Interlace Demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "Touhou-BadApple!30FPS4ColInterlace.sfc", create
...
seek($8000); Start:
  ...
  sta.w REG_BGMODE // $2105: BG Mode 5, Priority 1, BG2 16x8 Tiles
  ...
  lda.b #62 // Scroll BG2 62 Pixels Up
  ...
  sta.w REG_TS // $212D: BG2 To Sub Screen Designation (Needed To Show Interlace GFX)
...
RestartVid:
  ...
  ldx.w #6572>>2 // Load Frame Count / 4
  stx.b FrameCount // Store Frame Count

  ldy.w #8 // CGRAM Size In Bytes To DMA Transfer (2 Bytes For Each Colour)
VIDLoop:
  ...
  // Setup Frame 1 BG2 4 Colour Background
  lda.b #%00000000  // BBBBAAAA: A = BG1 Tile Address, B = BG2 Tile Address
  sta.w REG_BG12NBA // $210B: BG2 Tile Address = $0000 (VRAM Address / $1000)
  lda.b #%00011010  // AAAAAASS: S = BG Map Size, A = BG Map Address
  sta.w REG_BG2SC   // $2108: BG2 64x32, BG2 Map Address = $3200 (VRAM Address / $400)
  ...
  // Setup Frame 2 BG2 4 Colour Background
  lda.b #%00100000  // BBBBAAAA: A = BG2 Tile Address, B = BG2 Tile Address
  sta.w REG_BG12NBA // $210B: BG2 Tile Address = $4000 (VRAM Address / $1000)
  lda.b #%00111010  // AAAAAASS: S = BG Map Size, A = BG Map Address
  sta.w REG_BG2SC   // $2108: BG2 64x32, BG2 Map Address = $7200 (VRAM Address / $400)

  ////////////////////////////////////////////////////////
  // Load Frame 3 Tile Data To VRAM
  stx.w REG_DAS0L // Store Size Of Data Block ($4305: DMA Transfer Size/HDMA)
  lda.b #%00000001 // Initiate DMA Transfer (Channel 0)
  WaitNMI() // Wait For Frame 3 1st Vertical Blank
  sta.w REG_MDMAEN // $420B: DMA Enable

  // Load Frame 3 Tile Data & Map To VRAM, Followed By Palette To CGRAM
  stz.w REG_CGADD // $2121: CGRAM
  stx.w REG_DAS0L // Store Size Of Data Block ($4305: DMA Transfer Size/HDMA)
  sty.w REG_DAS1L // Store Size Of Data Block ($4315: DMA Transfer Size/HDMA)
  lda.b #%00000011 // Initiate DMA Transfer (Channel 0&1)
  WaitNMI() // Wait For Frame 3 2nd Vertical Blank
  sta.w REG_MDMAEN // $420B: DMA Enable

  // Setup Frame 3 BG2 4 Colour Background
  lda.b #%01000000  // BBBBAAAA: A = BG2 Tile Address, B = BG2 Tile Address
  sta.w REG_BG12NBA // $210B: BG2 Tile Address = $8000 (VRAM Address / $1000)
  lda.b #%01011010  // AAAAAASS: S = BG Map Size, A = BG Map Address
  sta.w REG_BG2SC   // $2108: BG2 64x32, BG2 Map Address = $B200 (VRAM Address / $400)

  ////////////////////////////////////////////////////////
  // Load Frame 4 Tile Data To VRAM
  stx.w REG_DAS0L // Store Size Of Data Block ($4305: DMA Transfer Size/HDMA)
  lda.b #%00000001 // Initiate DMA Transfer (Channel 0)
  WaitNMI() // Wait For Frame 4 1st Vertical Blank
  sta.w REG_MDMAEN // $420B: DMA Enable

  // Load Frame 4 Tile Data & Map To VRAM, Followed By Palette To CGRAM
  stz.w REG_CGADD // $2121: CGRAM
  stx.w REG_DAS0L // Store Size Of Data Block ($4305: DMA Transfer Size/HDMA)
  sty.w REG_DAS1L // Store Size Of Data Block ($4315: DMA Transfer Size/HDMA)
  lda.b #%00000011 // Initiate DMA Transfer (Channel 0&1)
  WaitNMI() // Wait For Frame 4 2nd Vertical Blank
  sta.w REG_MDMAEN // $420B: DMA Enable

  // Setup Frame 4 BG2 4 Colour Background
  lda.b #%01100000  // BBBBAAAA: A = BG2 Tile Address, B = BG2 Tile Address
  sta.w REG_BG12NBA // $210B: BG2 Tile Address = $C000 (VRAM Address / $1000)
...
// SPC Code
// BANK 0
insert SPCROM, "Touhou-BadApple!30FPS4ColInterlace.spc"