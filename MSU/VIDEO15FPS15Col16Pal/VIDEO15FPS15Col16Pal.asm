// SNES MSU1 Video 15 Frames Per Second 15 Color 16 Palette Demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "VIDEO15FPS15Col16Pal.sfc", create
...
VIDLoop:
  ////////////////////////////////////////////////////////
  ldx.w #7296 // VRAM Size In Bytes To DMA Transfer
  ldy.w #$0800 >> 1 // VRAM Destination
  ...
  ldx.w #6784 // VRAM Size In Bytes To DMA Transfer
  stx.w REG_DAS0L // Store Size Of Data Block ($4305: DMA Transfer Size/HDMA)
  ldy.w #512 // CGRAM Size In Bytes To DMA Transfer (2 Bytes For Each Colour)
  ...
  // Setup Frame 1 OBJ 16 Color Sprites
  lda.b #%01100001 // Object Size = 16x16/32x32, Name = 0, Base = $4000
  sta.w REG_OBSEL // $2101: Object Size & Object Base

  ////////////////////////////////////////////////////////
  ldx.w #7296 // VRAM Size In Bytes To DMA Transfer
  ldy.w #$8800 >> 1 // VRAM Destination
  sty.w REG_VMADDL  // $2116: VRAM
  ...
  // Setup Frame 2 OBJ 16 Color Sprites
...
OAM:
  // OAM Info (16x16 Sprites)
  db   0, 112,   0, %00000000
  db  16, 112,   2, %00000000
  db  32, 112,   4, %00000000
  db  48, 112,   6, %00000000

  db  64, 112,   8, %00000010
  db  80, 112,  10, %00000010
  db  96, 112,  12, %00000010
  db 112, 112,  14, %00000010

  db 128, 112,  96, %00000100
  db 144, 112,  98, %00000100
  db 160, 112, 100, %00000100
  db 176, 112, 102, %00000100

  db 192, 112, 104, %00000110
  db 208, 112, 106, %00000110
  db 224, 112, 108, %00000110
  db 240, 112, 110, %00000110

  // OAM Info (32x32 Sprites)
  db   0, 128,  32, %00000000
  db  32, 128,  36, %00000000

  db  64, 128,  40, %00000010
  db  96, 128,  44, %00000010

  db 128, 128, 128, %00000100
  db 160, 128, 132, %00000100

  db 192, 128, 136, %00000110
  db 224, 128, 140, %00000110


  db   0, 160, 192, %00001000
  db  32, 160, 196, %00001000

  db  64, 160, 200, %00001010
  db  96, 160, 204, %00001010

  db 128, 160,  64, %00001101
  db 160, 160,  68, %00001101

  db 192, 160,  72, %00001111
  db 224, 160,  76, %00001111


  db   0, 192,   0, %00001001
  db  32, 192,   4, %00001001

  db  64, 192,   8, %00001011
  db  96, 192,  12, %00001011

  db 128, 192, 128, %00001101
  db 160, 192, 132, %00001101

  db 192, 192, 136, %00001111
  db 224, 192, 140, %00001111

  // OAM Extra Info (16x16 Sprites)
  db %00000000
  db %00000000
  db %00000000
  db %00000000

  // OAM Extra Info (32x32 Sprites)
  db %10101010
  db %10101010
  db %10101010
  db %10101010
...
BGMap:
  include "TileMap16PAL256x224.asm" // Include BG Map Data (1792 Bytes)

// SPC Code
// BANK 0
insert SPCROM, "VIDEO15FPS15Col16Pal.spc"