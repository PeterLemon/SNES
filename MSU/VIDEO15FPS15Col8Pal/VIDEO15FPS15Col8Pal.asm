// SNES MSU1 Video 15 Frames Per Second 15 Color 8 Palette Demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "VIDEO15FPS15Col8Pal.sfc", create
...
// SPC Code
// BANK 0
insert SPCROM, "VIDEO15FPS15Col8Pal.spc"