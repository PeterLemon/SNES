// SNES MSU1 Video 15 Frames Per Second 16 Color Interlace Demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "VIDEO15FPS16ColInterlace.sfc", create
...
RestartVid:
  ...
  ldx.w #770>>1 // Load Frame Count / 2
...
VIDLoop:
  ...
  sta.w REG_BG1SC   // $2107: BG1 64x32, BG1 Map Address = $7000 (VRAM Address / $400)
...
// SPC Code
// BANK 0
insert SPCROM, "VIDEO15FPS16ColInterlace.spc"