// SNES MSU1 Video 15 Frames Per Second 16 Color Demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "VIDEO15FPS16Col.sfc", create
...
HDMATable:
  db  6, %10000000 // Repeat  6 Scanlines, Turn Off Screen, Zero Brightness
  db 26, %00001111 // Repeat 26 Scanlines, Turn On Screen, Full Brightness
...
BGMap:
  include "TileMap256x224.asm" // Include BG Map Data (1792 Bytes)

// SPC Code
// BANK 0
insert SPCROM, "VIDEO15FPS16Col.spc"