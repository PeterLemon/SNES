// SNES GSU 4BPP 256x128 Plot Pixel Demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "GSU4BPP256x128PlotPixel.sfc", create
...
CPURAM: // CPU Program Code To Be Run From RAM
  ...
  sta.w REG_BG2SC   // $2108: BG2 32x32, BG2 Map Address = $1F (VRAM Address / $400)
  ...
  lda.b #(GSU_RON|GSU_RAN|GSU_SCMR_4BPP|GSU_SCMR_H128) // Screen Size Mode
...
Refresh:
  ...
  WaitScanline:
      ...
      cmp.b #177 // Compare Scanline Y To 177
      bne WaitScanline
...
// BANK 0
GSUROM:
  include "GSU4BPP256x128PlotPixel_gsu.asm" // Include GSU ROM Data
BGMap:
  include "GSU256x128Map.asm" // Include GSU 256x128 BG Map (2048 Bytes)
HDMATable:
  db 32, %10000000 // Repeat 32 Scanlines, Turn Off Screen, Zero Brightness
  db 15, %10000000 // Repeat 15 Scanlines, Turn Off Screen, Zero Brightness
