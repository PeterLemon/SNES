// SNES GSU 4BPP 256x192 Plot Pixel Demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "GSU4BPP256x192PlotPixel.sfc", create
...
CPURAM: // CPU Program Code To Be Run From RAM
  ...
  LoadVRAM(BGBorderTile, $6000, $20, 0) // Load Background Border Tile To VRAM
  ...
  lda.b #(GSU_RON|GSU_RAN|GSU_SCMR_4BPP|GSU_SCMR_H192) // Screen Size Mode
...
// BANK 0
GSUROM:
  include "GSU4BPP256x192PlotPixel_gsu.asm" // Include GSU ROM Data
BGMap:
  include "GSU256x192Map.asm" // Include GSU 256x192 BG Map (2048 Bytes)
BGBorderTile:
  db $FF,$00,$FF,$00,$FF,$00,$FF,$00 // Include BG Border Tile (32 Bytes)
