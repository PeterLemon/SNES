// SNES GSU 4BPP 256x160 Fill Poly Demo (GSU Code) by krom (Peter Lemon):
arch snes.gsu
...
GSUStart:
  ...
  iwt r3, #(256*160)/2 // R3 = SRAM Destination
  ...
  iwt r3, #((256*160)/2)+96 // R3 = Scan Left RAM Address + Poly Top Scanline
  iwt r4, #((256*160)/2)+320+96 // R4 = Scan Right RAM Address + Poly Top Scanline
