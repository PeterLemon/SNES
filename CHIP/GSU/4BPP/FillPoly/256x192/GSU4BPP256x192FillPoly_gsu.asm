// SNES GSU 4BPP 256x192 Fill Poly Demo (GSU Code) by krom (Peter Lemon):
arch snes.gsu
...
GSUStart:
  ...
  iwt r3, #(256*192)/2 // R3 = SRAM Destination
  ...
  iwt r3, #((256*192)/2)+128 // R3 = Scan Left RAM Address + Poly Top Scanline
  iwt r4, #((256*192)/2)+384+128 // R4 = Scan Right RAM Address + Poly Top Scanline
