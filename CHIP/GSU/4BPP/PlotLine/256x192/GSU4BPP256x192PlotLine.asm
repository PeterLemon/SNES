// SNES GSU 4BPP 256x192 Plot Line Demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "GSU4BPP256x192PlotLine.sfc", create
...
// BANK 0
GSUROM:
  include "GSU4BPP256x192PlotLine_gsu.asm" // Include GSU ROM Data
BGMap:
