// SNES GSU 8BPP 256x128 Fill Poly Demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "GSU8BPP256x128FillPoly.sfc", create
...
// BANK 0
GSUROM:
  include "GSU8BPP256x128FillPoly_gsu.asm" // Include GSU ROM Data
BGMap:
