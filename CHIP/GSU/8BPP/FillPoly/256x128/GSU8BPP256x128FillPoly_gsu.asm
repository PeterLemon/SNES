// SNES GSU 8BPP 256x128 Fill Poly Demo (GSU Code) by krom (Peter Lemon):
arch snes.gsu
...
GSUStart:
  ...
  iwt r12, #(256*128)/2 // R12 = Loop Count
  ...
  iwt r3, #256*128 // R3 = SRAM Destination
  ...
  iwt r3, #(256*128)+64 // R3 = Scan Left RAM Address + Poly Top Scanline
  iwt r4, #(256*128)+256+64 // R4 = Scan Right RAM Address + Poly Top Scanline
