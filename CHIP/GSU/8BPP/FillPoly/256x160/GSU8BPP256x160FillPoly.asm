// SNES GSU 8BPP 256x160 Fill Poly Demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "GSU8BPP256x160FillPoly.sfc", create
...
// BANK 0
GSUROM:
  include "GSU8BPP256x160FillPoly_gsu.asm" // Include GSU ROM Data
BGMap:
