// SNES GSU 8BPP 256x160 Fill Poly Demo (GSU Code) by krom (Peter Lemon):
arch snes.gsu
...
GSUStart:
  ...
  iwt r12, #(256*160)/2 // R12 = Loop Count
  ...
  iwt r3, #256*160 // R3 = SRAM Destination
  ...
  iwt r3, #(256*160)+96 // R3 = Scan Left RAM Address + Poly Top Scanline
  iwt r4, #(256*160)+320+96 // R4 = Scan Right RAM Address + Poly Top Scanline
