// SNES GSU 8BPP 256x128 Plot Pixel Demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "GSU8BPP256x128PlotPixel.sfc", create
...
CPURAM: // CPU Program Code To Be Run From RAM
  ...
  sta.w REG_BG1SC   // $2107: BG1 32x32, BG1 Map Address = $1F (VRAM Address / $400)
  ...
  lda.b #(GSU_RON|GSU_RAN|GSU_SCMR_8BPP|GSU_SCMR_H128) // Screen Size Mode
...
// BANK 0
GSUROM:
  include "GSU8BPP256x128PlotPixel_gsu.asm" // Include GSU ROM Data
BGMap:
