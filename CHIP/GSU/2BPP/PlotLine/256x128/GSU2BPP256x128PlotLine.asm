// SNES GSU 2BPP 256x128 Plot Line Demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "GSU2BPP256x128PlotLine.sfc", create
...
// BANK 0
GSUROM:
  include "GSU2BPP256x128PlotLine_gsu.asm" // Include GSU ROM Data
BGMap:
