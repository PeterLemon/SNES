// SNES GSU 2BPP 256x160 Plot Line Demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "GSU2BPP256x160PlotLine.sfc", create
...
// BANK 0
GSUROM:
  include "GSU2BPP256x160PlotLine_gsu.asm" // Include GSU ROM Data
BGMap:
