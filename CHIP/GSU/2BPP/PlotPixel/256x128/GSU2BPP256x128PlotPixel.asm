// SNES GSU 2BPP 256x128 Plot Pixel Demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "GSU2BPP256x128PlotPixel.sfc", create
...
CPURAM: // CPU Program Code To Be Run From RAM
  ...
  lda.b #(GSU_RON|GSU_RAN|GSU_SCMR_2BPP|GSU_SCMR_H128) // Screen Size Mode
...
// BANK 0
GSUROM:
  include "GSU2BPP256x128PlotPixel_gsu.asm" // Include GSU ROM Data
BGMap:
