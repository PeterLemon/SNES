// SNES GSU 2BPP 256x192 Fill Poly Demo (CPU Code) by krom (Peter Lemon):
arch snes.cpu
output "GSU2BPP256x192FillPoly.sfc", create
...
// BANK 0
GSUROM:
  include "GSU2BPP256x192FillPoly_gsu.asm" // Include GSU ROM Data
BGMap:
