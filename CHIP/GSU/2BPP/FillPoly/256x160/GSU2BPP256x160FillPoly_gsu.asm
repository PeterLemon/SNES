// SNES GSU 2BPP 256x160 Fill Poly Demo (GSU Code) by krom (Peter Lemon):
arch snes.gsu
...
GSUStart:
  ...
  iwt r12, #(256*160)/8 // R12 = Loop Count
  ...
  iwt r3, #(256*160)/4 // R3 = SRAM Destination
  iwt r12, #(160*2)*2 // R12 = Loop Count
  move r13, r15 // R13 = Loop Address
  // Loop:
  ...
  iwt r3, #((256*160)/4)+96 // R3 = Scan Left RAM Address + Poly Top Scanline
  iwt r4, #((256*160)/4)+320+96 // R4 = Scan Right RAM Address + Poly Top Scanline
  ibt r2, #48 // R2 = Plot Y Position
