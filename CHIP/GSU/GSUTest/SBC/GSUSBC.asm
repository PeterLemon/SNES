// SNES GSU Test SBC (Subtract With Borrow) demo by krom (Peter Lemon):
arch snes.cpu
output "GSUSBC.sfc", create
...
CPURAM: // CPU Program Code To Be Run From RAM
  ...
  PrintText(SBCRegister, $F902, 30) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR0, $FA02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR0, $FA42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR1, $FA82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR1, $FAC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR2, $FB02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR2, $FB42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR3, $FB82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR3, $FBC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR4, $FC02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR4, $FC42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR5, $FC82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR5, $FCC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR6, $FD02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR6, $FD42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR7, $FD82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR7, $FDC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR8, $FA02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR8, $FA42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR9, $FA82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR9, $FAC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR10, $FB02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR10, $FB42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR11, $FB82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR11, $FBC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR12, $FC02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR12, $FC42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR13, $FC82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR13, $FCC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR14, $FD02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR14, $FD42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR15, $FD82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(SBCR15, $FDC2, 7) // Load Text To VRAM Lo Bytes
...
Title:
  db "GSU Test SBC (Sub With Borrow)"
...
// BANK 0
GSUROM:
  include "GSUSBC_gsu.asm" // Include GSU ROM Data
