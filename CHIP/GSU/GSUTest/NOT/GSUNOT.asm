// SNES GSU Test NOT (Compliment Bits) demo by krom (Peter Lemon):
arch snes.cpu
output "GSUNOT.sfc", create
...
CPURAM: // CPU Program Code To Be Run From RAM
  ...
  PrintText(NOTRegister, $F902, 30) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR0, $FA02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR0, $FA42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR1, $FA82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR1, $FAC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR2, $FB02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR2, $FB42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR3, $FB82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR3, $FBC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR4, $FC02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR4, $FC42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR5, $FC82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR5, $FCC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR6, $FD02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR6, $FD42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR7, $FD82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR7, $FDC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR8, $FA02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR8, $FA42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR9, $FA82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR9, $FAC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR10, $FB02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR10, $FB42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR11, $FB82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR11, $FBC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR12, $FC02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR12, $FC42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR13, $FC82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR13, $FCC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR14, $FD02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR14, $FD42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(NOTR15, $FD82, 7) // Load Text To VRAM Lo Bytes
...
Title:
  db "GSU Test NOT (Compliment Bits)"
...
// BANK 0
GSUROM:
  include "GSUNOT_gsu.asm" // Include GSU ROM Data
