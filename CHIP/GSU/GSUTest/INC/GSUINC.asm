// SNES GSU Test INC (Increment) demo by krom (Peter Lemon):
arch snes.cpu
output "GSUINC.sfc", create
...
CPURAM: // CPU Program Code To Be Run From RAM
  ...
  PrintText(INCRegister, $F902, 30) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR0, $FA02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR0, $FA42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR1, $FA82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR1, $FAC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR2, $FB02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR2, $FB42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR3, $FB82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR3, $FBC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR4, $FC02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR4, $FC42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR5, $FC82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR5, $FCC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR6, $FD02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR6, $FD42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR7, $FD82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR7, $FDC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR8, $FA02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR8, $FA42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR9, $FA82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR9, $FAC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR10, $FB02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR10, $FB42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR11, $FB82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR11, $FBC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR12, $FC02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR12, $FC42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR13, $FC82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR13, $FCC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR14, $FD02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(INCR14, $FD42, 7) // Load Text To VRAM Lo Bytes
...
// BANK 0
GSUROM:
  include "GSUINC_gsu.asm" // Include GSU ROM Data
