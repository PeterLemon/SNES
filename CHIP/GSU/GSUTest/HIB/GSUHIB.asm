// SNES GSU Test HIB (Hi Byte) demo by krom (Peter Lemon):
arch snes.cpu
output "GSUHIB.sfc", create
...
CPURAM: // CPU Program Code To Be Run From RAM
  ...
  PrintText(HIBRegister, $F902, 30) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR0, $FA02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR0, $FA42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR1, $FA82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR1, $FAC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR2, $FB02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR2, $FB42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR3, $FB82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR3, $FBC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR4, $FC02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR4, $FC42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR5, $FC82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR5, $FCC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR6, $FD02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR6, $FD42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR7, $FD82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR7, $FDC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR8, $FA02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR8, $FA42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR9, $FA82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR9, $FAC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR10, $FB02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR10, $FB42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR11, $FB82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR11, $FBC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR12, $FC02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR12, $FC42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR13, $FC82, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR13, $FCC2, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR14, $FD02, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR14, $FD42, 7) // Load Text To VRAM Lo Bytes
  ...
  WaitNMI() // Wait For VSync
  PrintText(HIBR15, $FD82, 7) // Load Text To VRAM Lo Bytes
...
// BANK 0
GSUROM:
  include "GSUHIB_gsu.asm" // Include GSU ROM Data
